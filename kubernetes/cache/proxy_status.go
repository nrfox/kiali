...
func (c *KialiCache) CheckProxyStatus() bool {
...
func (c *KialiCache) GetPodProxyStatus(namespace, pod string) *kubernetes.ProxyStatus {
	defer c.proxyStatusLock.RUnlock()
	c.proxyStatusLock.RLock()
...
func (c *KialiCache) SetProxyStatus(proxyStatus []*kubernetes.ProxyStatus) {
...
func (c *KialiCache) RefreshProxyStatus() {
	defer c.proxyStatusLock.Unlock()
	c.proxyStatusLock.Lock()

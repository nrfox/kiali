...
const (
	uiDefaultFixtureLocation = "../kiali-ui/cypress/fixtures/generated"
)
...
func init() {
	...
	flag.StringVar(&outputFlag, "output", path.Join(kialiProjectRoot, uiDefaultFixtureLocation), "path to output the generated json")
